<?php
    ...
    class Usuari{
        ...
        public function add(){
            $db = new connexio();
            $db2 = $db->query("INSERT INTO Usuari(`nickname`, `email`, `password`, `nom`, `cognom`, `telefon`, `pais`, `id_tipus`, `imatge`) "
                    . "VALUES ($this->nickname', '$this->email', '$this->password', '$this->nom', '$this->cognom', '$this->telefon', '$this->pais', '$this->id_tipus', '$this->imatge')");
            $db->close();
            return $db2;
        }
        ...
        public function view_all(){
            ...
            while($obj = $query->fetch_assoc()){
                $Usuari = new Usuari($obj["id_usuari"],$obj["nickname"],$obj["email"],$obj["password"],$obj["nom"],$obj["cognom"],$obj["telefon"],$obj["pais"],$obj["id_tipus"],$obj["imatge"]);
                //var_dump($Usuari);
        ...
        public function view_comp($id){
            ...
            $rtn = array();
            while($obj = $query->fetch_assoc()){
                $Usuari = new Usuari($obj["nickname"],$obj["email"],$obj["password"],$obj["nom"],$obj["cognom"],$obj["telefon"],$obj["pais"],$obj["id_tipus"],$obj["imatge"]);
                //var_dump($Usuari);
                array_push($rtn, $Usuari);
            }
            $db->close();
        ...
        function __construct(){
            ...
            if (method_exists($this, $f)) {
                call_nickname_func_array(array($this, $f), $args);
            }
        }
